...
CREATE TABLE `atendimento` (
  `codigoAtendimento` int(11) NOT NULL AUTO_INCREMENT,
  `codigoPaciente` int(11) NOT NULL,
  `senhaAtendimento` int(11) NOT NULL,
  `dataAtendimento` date NOT NULL,
  `horaAtendimento` time NOT NULL,
  `guicheAtendimento` varchar(2) NOT NULL,
  `convenioAtendimento` varchar(50) NOT NULL,
  `desdobramentoAtendimento` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`codigoAtendimento`,`codigoPaciente`),
  KEY `codigoPaciente` (`codigoPaciente`),
  CONSTRAINT `atendimento_ibfk_1` FOREIGN KEY (`codigoPaciente`) REFERENCES `paciente` (`codigoPaciente`)
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `login` (
  `codigoLogin` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `paciente` (
  ...
  `responsavelPaciente` varchar(60) DEFAULT NULL,
...
-- Dump completed on 2020-07-11 17:59:58
